...
<body>
	...
	<ul>
		...
		for (Photo photo : photoList) {
			...
			// 関東地方の県のみ表示する条件を追加
			if (photo.getLocation().equals("東京都") || photo.getLocation().equals("神奈川県") || photo.getLocation().equals("埼玉県")
			|| photo.getLocation().equals("千葉県") || photo.getLocation().equals("茨城県")
			|| photo.getLocation().equals("栃木県") || photo.getLocation().equals("群馬県")) {
		%>
		<li>
			<div>
